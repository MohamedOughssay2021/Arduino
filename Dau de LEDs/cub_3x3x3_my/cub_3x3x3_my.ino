...
void loop ()
{
    ...
    // paste UI output here (https://rawgithub.com/gzip/arduino-ledcube/master/ui/index.html)
        ...
        cube.createFrame((const byte[]) {0,4, 1,1, 1,3, 1,4, 1,5, 1,7, 2,4}, 14, 108),
        cube.createFrame((const byte[]) {0,1, 0,3, 0,4, 0,5, 0,7, 1,0, 1,2, 1,6, 1,8, 2,1, 2,3, 2,4, 2,5, 2,7}, 28, 108),
        cube.createFrame((const byte[]) {0,4, 1,1, 1,3, 1,4, 1,5, 1,7, 2,4}, 14, 108),
        cube.createFrame((const byte[]) {1,4}, 2, 108),
        cube.createFrame((const byte[]) {0,4, 1,1, 1,3, 1,4, 1,5, 1,7, 2,4}, 14, 108),
        cube.createFrame((const byte[]) {0,1, 0,3, 0,4, 0,5, 0,7, 1,0, 1,2, 1,6, 1,8, 2,1, 2,3, 2,4, 2,5, 2,7}, 28, 108),
